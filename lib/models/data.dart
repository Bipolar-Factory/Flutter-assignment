...
class Data {
  ...
  static final User me = raza;

  static List<ChatRoom> chatRooms = [
    ChatRoom(sender: rahul, messages: chat4),
    ChatRoom(sender: john, messages: chat3),
